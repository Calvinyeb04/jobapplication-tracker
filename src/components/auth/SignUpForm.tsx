        ...
        <div className="space-y-5">
          <div className="relative">
            <input
              ...
              type="text"
              {...register('name')}
              className={`block w-full px-4 py-3 text-gray-900 bg-white border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 peer placeholder-transparent`}
              placeholder="Name"
            />
            <label 
              htmlFor="name" 
          ...
          <div className="relative">
            <input
              ...
              className={`block w-full px-4 py-3 text-gray-900 bg-white border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 peer placeholder-transparent`}
